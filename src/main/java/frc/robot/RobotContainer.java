...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    .whenPressed(new InstantCommand(m_shooter).beforeStarting(() -> System.out.println("SHOOT!!!")));

    new JoystickButton(m_drivController, Button.kB.value)
    .whenReleased(new InstantCommand(m_shooter).beforeStarting(() -> System.out.println("STOP!!!")));
  }
